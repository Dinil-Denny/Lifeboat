        ...
        <div className="h-screen bg-brand-darkGreen flex justify-center items-center">
            <div className="bg-white mx-auto my-5 px-5 py-3 rounded shadow">
                <div className="flex flex-col items-center justify-center my-4">
                    ...
                    <p className="text-sm text-center">Please enter your email and password to continue</p>
                </div>
                <form action="">
                    <div>
                        <input className="input validator bg-gray-200" type="email" required placeholder="Enter email" />
                    ...
                    <div className="flex my-5">
                        <button className="bg-brand-darkGreen mx-auto text-white h-10 w-full rounded">Log In</button>
                    </div>
                </form>
            </div>
        </div>
