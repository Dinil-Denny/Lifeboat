      ...
      <div>
        <div className='flex flex-col md:flex-row text-justify mx-16 my-5 md:mx-20'>
          <div className='md:w-1/2'>
              ...
              <p>Facing a medical emergency and need help with hospital expenses? 
                  Don’t face it alone. Start your fundraiser today, share your story, and connect with compassionate donors who can make a difference. 
                  Whether it's for surgery, treatment, or recovery, we are here to support you every step of the way. 
                  Your journey to recovery begins with a single step.
              </p>
        ...
        <div className='flex flex-col-reverse md:flex-row text-justify mx-16 my-5 md:mx-20'>
          ...
          <div className='md:w-1/2'>
              <h5 className="text-left sm:text-justify">Extend a helping hand to those in need</h5>
              <p>Join hands to support medical emergencies. 
                  Your contribution can be the reason someone gets a second chance at life.
              </p>
